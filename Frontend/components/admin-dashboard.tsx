...
import { hotels as initialHotels, type Hotel as HotelType } from "@/lib/hotel-data"
    ...
    const hotel: HotelType = {
      ...
      rooms: [
        ...
        },
        {
          id: `${Date.now()}-sup`,
          type: "Superior Room",
          description: "Spacious room with lounge area and premium furnishings.",
      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-16">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          <div className="rounded-xl border border-border bg-card p-4">
            ...
            <p className="mt-1 font-serif text-2xl font-bold text-foreground">
              {hotelList.length
                ? (hotelList.reduce((s, h) => s + h.rating, 0) / hotelList.length).toFixed(
                    1
                  )
                : "N/A"}
            </p>
                          ...
                          >
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {room.size}m2 &middot; Up to {room.capacity} guests
                              </p>
                            </div>
