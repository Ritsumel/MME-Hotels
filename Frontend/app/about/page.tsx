        ...
        <div className="grid gap-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              ...
              envisioned hotels that feel like a second home, where every surface,
              every flavor, and every interaction is thoughtfully crafted.
            </p>
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Today, with four properties across Sweden, we continue to honor that
              vision. Each hotel is unique in character but united by a shared
              commitment to quality, sustainability, and the warm welcome that
              defines Swedish hospitality.
            </p>
